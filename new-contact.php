...
<body class="font-Mochiy font-extralight">
    ...
    <nav id="destop-nav" class="hidden lg:flex lg:flex-row lg:items-center lg:gap-8" aria-label="desktop-nav">
        ...
        <div>
            <a href="/new-contact.php" class="bg-gradient-to-br from-pink-300 to-rose-300 text-pink-800 font-bold px-4 py-2 shadow-md rounded-lg hover:from-pink-300 hover:to-purple-300 focus:bg-gradient-to-br focus:from-pink-400 focus:to-purple-300">New Contact</a>
            <button id="logout-btn" class="bg-gradient-to-br from-pink-300 to-rose-300 text-pink-800 font-bold px-4 py-2 shadow-md rounded-lg hover:from-pink-300 hover:to-purple-300 focus:bg-gradient-to-br focus:from-pink-400 focus:to-purple-300">Logout</button>
        </div>
        ...
        <div class="max-w-lg mx-auto px-8 py-8 bg-white border-2 border-pink-500 rounded-lg shadow-md z-10">
            ...
            <form id="new-contact-form">
                ...
                <div class="text-center">
                    ...
                    <button type="submit" class="bg-gradient-to-br from-pink-300 to-rose-300 text-pink-800 font-semibold py-3 px-8 hover:bg-gradient-to-br hover:from-pink-300 hover:to-purple-300 rounded-lg shadow-lg transition duration-300 ease-in-out">Create Contact</button>
