...
<head>
    ...
    <title>ContactKeepr >> New Contact</title>
        ...
        <div class="max-w-lg mx-auto px-8 py-8 bg-white rounded-lg shadow-md">
            ...
            <form id="new-contact-form">
                ...
                <div class="text-center">
                    ...
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg transition duration-300 ease-in-out">Create Contact</button>
